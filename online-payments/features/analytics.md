---
description: "Custom data sent to HiPay can be used in our Analytics Platform. The tables below describe the fields to set up and the reportings in which custom dat"
icon: file-lines
---
...
{% hint style="info" %}
Imported from the current HiPay WordPress developer portal for the demo migration. Source: [https://developer.hipay.com/online-payments/features/analytics](https://developer.hipay.com/online-payments/features/analytics)
{% endhint %}
...
E.g., Champs-Elysees store - Paris
