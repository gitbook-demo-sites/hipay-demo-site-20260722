---
description: "HiPay Professional is fully integrated into WiziShop, allowing you to accept payments from your WiziShop online store. You don't need any technical kn"
icon: file-lines
---

# WiziShop Professional

{% hint style="info" %}
Imported from the current HiPay WordPress developer portal for the demo migration. Source: [https://developer.hipay.com/cms-modules/wizishop/wizishop-professional](https://developer.hipay.com/cms-modules/wizishop/wizishop-professional)
{% endhint %}
...
You need a WiziShop account. If you don't have one yet, you can create a store directly on the WiziShop website .
